<template>
  <div class="body w-full h-[100vh] relative md:px-5">
    ...
    >
      <button
        @click="addTask()"
        class="h-full text-sm absolute right-0 font-semibold2 text-gray-200 hover:tracking-widest px-[6px] duration-300 transition-all bg-orange-400 z-10 hover:opacity-70"
      >
        Add task
      </button>
      <input
